...
python $HOME/egfp/thz_continuous_simulation.py -n 4 -o EF_10MV_cm -t0 10 -t1 200 -t2 100&
python $HOME/egfp/thz_continuous_postproc.py -n 4 -o EF_10MV_cm -t0 10 -t1 200 -t2 100
